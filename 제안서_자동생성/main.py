...
def make_prompt(row):
    ...
    prompt = f"""
    아래 조건을 참조해서 멋진 협업 제안서를 한편 작성해줘.
    
    - 메일 형식으로 작성해줘.
    - 작성할 때 {row.company}의 최근 사업을 칭찬하고 앞으로 더욱 발전을 기대하는 표현을 넣어줘.
    ...
    위 정보와 요구사항을 참고해서 {row.company}에 보내는 제안서 본문을 완성해줘.
    """
